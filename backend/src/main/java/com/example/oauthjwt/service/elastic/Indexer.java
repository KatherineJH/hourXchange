...
public class Indexer {
  ...
  private void indexBoards() {
    ...
    boards.forEach(board -> {
      ...
      // .authorName(board.getAuthor() != null ?
      // board.getAuthor().getName()
      // : "Unknown")
      // .createdAt(board.getCreatedAt())
      // .suggest(Stream.of(board.getTitle(),
      ...
      BoardDocument doc = BoardDocument.builder().id(board.getId()).title(board.getTitle())
          .description(board.getDescription()).authorName(board.getAuthor().getName()).createdAt(board.getCreatedAt())
          .suggest(keywords).build();
      try {
