...
public interface DonationRepository extends JpaRepository<Donation, Long>, DonationRepositoryCustom {
    ...
    @Query("""
            ...
            """)
    List<Donation> findTopByProgress(DonationStatus status, LocalDate today, Pageable limit);
    ...
    @Query("""
            ...
            """)
    List<Donation> findTopByViewCount(DonationStatus status, LocalDate today, Pageable limit);
