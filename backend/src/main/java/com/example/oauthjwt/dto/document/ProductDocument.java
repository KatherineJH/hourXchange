...
public class ProductDocument {
    ...
    public static ProductDocument toDocument(Product product, String ownerName, List<String> finalKeywords,
            double starsAverage) {
        return ProductDocument.builder().id(product.getId()).title(product.getTitle())
                ...
                .starsAverage(starsAverage).reviewCount(product.getReviews().size()).ownerName(ownerName)
