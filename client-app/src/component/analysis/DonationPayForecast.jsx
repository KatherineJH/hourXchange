// src/component/analysis/DonationPayForecast.jsx
...
import { getDonationPayByRange } from "../../api/donationHistoryApi.js";
...
const DonationPayForecast = () => {
  ...
  useEffect(() => {
    ...
    const fetchAndForecast = async () => {
      try {
        const response = await getDonationPayByRange(
...
export default DonationPayForecast;
