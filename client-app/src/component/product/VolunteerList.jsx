...
import {
    Box, Button, FormControl, FormLabel, RadioGroup, FormControlLabel, Radio,
...
const areaOptions = [
    { name: '서울', code: '0101' }, { name: '부산', code: '0102' }, { name: '대구', code: '0103' }, { name: '인천', code: '0104' }, { name: '광주', code: '0105' },
    { name: '대전', code: '0106' }, { name: '울산', code: '0107' }, { name: '세종', code: '0117' }, { name: '경기', code: '0108' }, { name: '강원', code: '0109' },
    { name: '충북', code: '0110' }, { name: '충남', code: '0111' }, { name: '전북', code: '0112' }, { name: '전남', code: '0113' }, { name: '경북', code: '0114' },
    { name: '경남', code: '0115' }, { name: '제주', code: '0116' }
];
...
export default function VolunteerList() {
    ...
    const openInNewTab = (seq) => {
        window.open('https://www.vms.or.kr/partspace/recruitView.do?seq=' + seq, '_blank', 'noopener,noreferrer');
    };
